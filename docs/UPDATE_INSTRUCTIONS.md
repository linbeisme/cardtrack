# Beginner GitHub Update Instructions — CardTrack v5.2.5
...
8. Use the commit message: `Upgrade CardTrack to v5.2.5`.
...
1. Confirm the app version displays **v5.2.5**.
